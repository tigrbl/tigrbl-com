...
import { Github, Shield, Terminal, Scale, HelpCircle } from "lucide-react";
...
export function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer id="global-footer" className="bg-[#0A0A0B] border-t border-white/5 text-slate-400 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 text-[11px] font-mono bg-slate-900/50 p-2 rounded-lg border border-white/5 max-w-fit">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs font-mono">
              ...
              <li>
                <a
                  href="https://github.com/tigrbl/tigrbl/issues"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-500 flex items-center gap-1.5 hover:text-orange-400"
                >
              ...
              <li>
                <span className="text-slate-500 flex items-center gap-1.5" title={`Verified on: ${VERIFIED_DATE}`}>
                  ...
                  <span>Verified {VERIFIED_DATE}</span>
                </span>
              </li>
            </ul>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-1.5">
                {["postgres", "servers", "templates", "tests"].map((extra) => (
                  <span
                    key={extra}
                    className="px-2 py-0.5 rounded text-[10px] font-mono font-medium bg-slate-900 border border-white/5 text-slate-300"
                  >
                    [{extra}]
                  </span>
                ))}
        ...
        <div className="mt-12 pt-6 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4 text-[11px] text-slate-500">
          <div>
            <span>© 2026 Tigrbl. Licensed under the </span>
            <a
              href="https://github.com/tigrbl/tigrbl/blob/master/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
