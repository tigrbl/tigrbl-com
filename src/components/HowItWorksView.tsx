  ...
  return (
    <div className="bg-[#0A0A0B] text-slate-200 min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-slate-900/30 border border-slate-800/60 rounded-xl p-8 mb-16 shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 relative">
            {/* Step 1 */}
            <div className="bg-slate-950 p-5 rounded-lg border border-slate-850 relative">
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              ...
              <div className="bg-slate-900/30 p-4 rounded-lg border border-slate-800 space-y-2">
            ...
            <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-5 font-mono text-xs text-slate-300">
              <span className="text-[10px] text-slate-500 block uppercase mb-2">Canonical Code Concept</span>
              <div className="bg-slate-950/80 p-4 rounded border border-slate-850 overflow-x-auto whitespace-pre leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center lg:flex-row-reverse">
            <div className="lg:order-2 space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xl font-display font-bold text-slate-200">Intermediate Specification Compiling</h3>
              </div>
              <p className="text-slate-400 text-xs sm:text-sm leading-relaxed">
              ...
              <p className="text-slate-400 text-xs leading-relaxed">
                This specification preserves validation signatures, parameter types, documentation metadata, and execution settings in a pure Python metadata format that is completely independent of transport layers like TCP or HTTP.
              </p>
            </div>

            <div className="lg:order-1 bg-slate-900/40 border border-slate-800 rounded-xl p-5 font-mono text-xs text-slate-300">
...
{`{
  ...
  "maturity": "Alpha"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-5 font-mono text-xs text-slate-300">
              <span className="text-[10px] text-slate-500 block uppercase mb-2">Simulated Pre-boot Kernel Plan Dump</span>
              <div className="bg-slate-950/80 p-3 rounded border border-slate-850 max-h-[220px] overflow-y-auto space-y-1.5 text-[11px] text-slate-400">
                <div>[01] BOOT: Compile schemas to target JSON specifications</div>
                <div>[02] MIDDLEWARE: Mount CorsGuard (origin restriction check)</div>
                <div>[03] VALIDATION: Attach PydanticSchema check to payload</div>
                <div>[04] DATABASE: Pre-fetch connection pools for PostgresEngine</div>
                <div>[05] ROUTE_MAP: REST GET /accounts/&lt;id&gt; =&gt; check_balance</div>
                <div>[06] ROUTE_MAP: RPC account.get =&gt; check_balance</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-tr from-slate-900/40 to-slate-950 border border-slate-800/80 rounded-xl p-8 text-center">
